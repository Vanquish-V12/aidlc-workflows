...
//
// t188 - the P0 compose surfaces (adaptive workflows):
...
// ===========================================================================
describe("t188 compose is NOT a terminal command (Kiro seam regression)", () => {
...
// ===========================================================================
describe("t188 cold-start compose surfaces -> composer dispatch", () => {
...
// ===========================================================================
describe("t188 mid-flow compose -> in-flight dispatch, not an advance", () => {
...
// ===========================================================================
describe("t188 Branch 8: inference confirm + compose offer", () => {
...
// ===========================================================================
describe("t188 detect --json is a pure read that names the write target", () => {
